...
### 🏥 [Health Management System](https://github.com/YEFF190/Health-Management-System-)
A desktop application built with **Java & JavaFX** to help hospitals manage patients, doctors, appointments, and medical records with role-based dashboards.

### 🎮 [MyDoodleJumpGame](https://github.com/YEFF190/MyDoodleJumpGame)
A classic Doodle Jump game recreation built in **C++**.
